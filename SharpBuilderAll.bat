rem Description: Clones down all the git repos from SharpAllTheThings
rem Written for WSL as it will use VS2019 to compile in BuildAllTheThings.bat
rem Converted so it will run with chocaolatey git in dos
rem Setup
